...
const games = [
  ...
  // ─── 2026-03-19 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_b: { name: 'Corbin Burnes', team: 'Baltimore Orioles', stats: { era: 2.92, wins: 15, k: 181, whip: 1.10 }, statLabel: '2024 Season' },
  ...
  // ─── 2026-04-06 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_b: { name: 'Kyle Tucker', team: 'Houston Astros', stats: { avg: .289, hr: 19, rbi: 40, ops: .871 }, statLabel: '2024 Season (Injury-Limited)' },
