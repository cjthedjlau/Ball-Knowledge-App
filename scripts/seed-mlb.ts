...
const games = [
  // ─── 2026-03-15 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Aaron Judge', team: 'New York Yankees', stats: { avg: .322, hr: 58, rbi: 144 }, statLabel: '2024 Season' },
    showdown_player_b: { name: 'Shohei Ohtani', team: 'Los Angeles Dodgers', stats: { avg: .310, hr: 54, rbi: 130 }, statLabel: '2024 Season' },
    showdown_category: 'WHO HAD THE BETTER 2024 SEASON?',
    showdown_correct_answer: 'a',
    showdown_correct_reason: 'Judge hit 58 HRs and won the AL MVP with a .322 average and 144 RBI — numerically the best season in either league, though Ohtani\'s 50-50 was historically unique.',
    blind_rank_players: [
      ...
      { name: 'Juan Soto', team: 'New York Yankees', rankingStat: 41, statLabel: 'Home Runs (2024)' },
  ...
  // ─── 2026-03-16 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Babe Ruth', team: 'New York Yankees', stats: { career_hr: 714, career_avg: .342, career_ops: 1.164 }, statLabel: 'Career' },
    showdown_player_b: { name: 'Hank Aaron', team: 'Atlanta Braves', stats: { career_hr: 755, career_avg: .305, career_rbi: 2297 }, statLabel: 'Career' },
    showdown_category: 'GREATEST HOME RUN HITTER EVER?',
    showdown_correct_answer: 'b',
    showdown_correct_reason: 'Aaron holds the legitimate all-time HR record at 755, with greater consistency (25 seasons) and a superior RBI total — achieved without the era advantages Ruth had.',
    blind_rank_players: [
      ...
      { name: 'Juan Soto', team: 'New York Yankees', rankingStat: 109, statLabel: 'RBI (2024)' },
    ],
  ...
  // ─── 2026-03-17 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Willie Mays', team: 'San Francisco Giants', stats: { career_hr: 660, career_avg: .302, career_sb: 338 }, statLabel: 'Career' },
    showdown_player_b: { name: 'Ted Williams', team: 'Boston Red Sox', stats: { career_avg: .344, career_obp: .482, career_hr: 521 }, statLabel: 'Career' },
    showdown_category: 'GREATEST ALL-AROUND HITTER EVER?',
    showdown_correct_answer: 'b',
    showdown_correct_reason: 'Williams\' .344 career average and .482 OBP (the highest ever) make him the purest hitter in history — he hit .406 in 1941, the last player ever above .400.',
    blind_rank_players: [
  ...
  // ─── 2026-03-18 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Sandy Koufax', team: 'Los Angeles Dodgers', stats: { career_era: 2.76, career_k: 2396, no_hitters: 4 }, statLabel: 'Career (1955-1966)' },
    showdown_player_b: { name: 'Nolan Ryan', team: 'Houston Astros', stats: { career_k: 5714, no_hitters: 7, career_wins: 324 }, statLabel: 'Career (1966-1993)' },
    showdown_category: 'GREATEST PITCHER OF ALL TIME?',
    showdown_correct_answer: 'b',
    showdown_correct_reason: 'Ryan\'s 7 no-hitters and 5,714 strikeouts are records that may never be broken — his career longevity (27 seasons) and dominance make him the all-time pitching king.',
    blind_rank_players: [
  ...
  // ─── 2026-03-19 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_b: { name: 'Cal Ripken Jr', team: 'Baltimore Orioles', stats: { consecutive_games: 2632, career_hr: 431, career_avg: .276 }, statLabel: 'Career' },
    showdown_category: 'GREATER YANKEE/ORIOLE LEGEND?',
    showdown_correct_answer: 'b',
    showdown_correct_reason: 'Ripken\'s 2,632 consecutive games record is the most unbreakable record in sports — pure, selfless dedication to his team over 16 years without a day off.',
    blind_rank_players: [
      { name: 'Freddie Freeman', team: 'Los Angeles Dodgers', rankingStat: 22, statLabel: 'Home Runs (2024)' },
      { name: 'Mookie Betts', team: 'Los Angeles Dodgers', rankingStat: 19, statLabel: 'Home Runs (2024)' },
      { name: 'Yordan Alvarez', team: 'Houston Astros', rankingStat: 35, statLabel: 'Home Runs (2024)' },
  ...
  // ─── 2026-03-20 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Mickey Mantle', team: 'New York Yankees', stats: { career_hr: 536, career_avg: .298, triple_crowns: 1 }, statLabel: 'Career' },
    showdown_player_b: { name: 'Willie Mays', team: 'San Francisco Giants', stats: { career_hr: 660, career_avg: .302, gold_gloves: 12 }, statLabel: 'Career' },
    showdown_category: 'MANTLE VS MAYS: WHO WAS BETTER?',
    showdown_correct_answer: 'b',
    showdown_correct_reason: 'Mays edged Mantle in career production (660 HR vs 536, 12 Gold Gloves) — and he played healthy longer, while Mantle battled injuries throughout his career.',
    blind_rank_players: [
  ...
  // ─── 2026-03-21 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Sandy Koufax', team: 'Los Angeles Dodgers', stats: { era_1963_66: 1.86, k_per_9: 9.3, cy_youngs: 3 }, statLabel: 'Peak 1963-1966' },
    showdown_player_b: { name: 'Greg Maddux', team: 'Atlanta Braves', stats: { career_era: 3.16, career_wins: 355, cy_youngs: 4 }, statLabel: 'Career' },
    showdown_category: 'MOST DOMINANT PITCHER PEAK vs CAREER?',
    showdown_correct_answer: 'a',
    showdown_correct_reason: 'Koufax\'s 4-year peak from 1963-1966 — back-to-back sub-2.00 ERA seasons, 3 Cy Youngs, 4 no-hitters — is the most dominant sustained run by any pitcher ever.',
    blind_rank_players: [
  ...
  // ─── 2026-03-22 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Hank Aaron', team: 'Atlanta Braves', stats: { career_hr: 755, career_rbi: 2297, career_avg: .305 }, statLabel: 'Career' },
    showdown_player_b: { name: 'Ken Griffey Jr', team: 'Seattle Mariners', stats: { career_hr: 630, career_avg: .284, gold_gloves: 10 }, statLabel: 'Career' },
    showdown_category: 'GREATER ALL-AROUND LEGEND?',
    showdown_correct_answer: 'a',
    showdown_correct_reason: 'Aaron\'s 755 HR all-time record, 2,297 RBI (all-time record), and 25-year consistency make him the most complete player-to-player comparison in MLB history.',
    blind_rank_players: [
      { name: 'Fernando Tatis Jr', team: 'San Diego Padres', rankingStat: 31, statLabel: 'Home Runs (2024)' },
      { name: 'Shohei Ohtani', team: 'Los Angeles Dodgers', rankingStat: 54, statLabel: 'Home Runs (2024)' },
      { name: 'Aaron Judge', team: 'New York Yankees', rankingStat: 58, statLabel: 'Home Runs (2024)' },
  ...
  // ─── 2026-03-23 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Babe Ruth', team: 'New York Yankees', stats: { career_hr: 714, career_ops: 1.164, seasons_leading_al: 12 }, statLabel: 'Career' },
    showdown_player_b: { name: 'Willie Mays', team: 'San Francisco Giants', stats: { career_hr: 660, career_sb: 338, gold_gloves: 12 }, statLabel: 'Career' },
    showdown_category: 'GREATEST BASEBALL PLAYER EVER?',
    showdown_correct_answer: 'a',
    showdown_correct_reason: 'Ruth transformed baseball — he hit more HRs than entire teams, pitched a World Series ERA of 0.87, and posted the highest OPS ever recorded. The game\'s first superstar.',
    blind_rank_players: [
  ...
  // ─── 2026-03-24 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Derek Jeter', team: 'New York Yankees', stats: { career_hits: 3465, ws_rings: 5, career_avg: .310 }, statLabel: 'Career' },
    showdown_player_b: { name: 'Mickey Mantle', team: 'New York Yankees', stats: { career_hr: 536, career_ops: 0.977, triple_crowns: 1 }, statLabel: 'Career' },
    showdown_category: 'GREATEST YANKEE EVER?',
    showdown_correct_answer: 'b',
    showdown_correct_reason: 'Despite injuries, Mantle\'s .977 career OPS and 536 HRs represent elite power production — many historians rank him above Jeter for pure talent and peak performance.',
    blind_rank_players: [
  ...
  // ─── 2026-03-25 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Shohei Ohtani', team: 'Los Angeles Dodgers', stats: { hr: 54, sb: 59, avg: .310 }, statLabel: '2024 Season' },
    showdown_player_b: { name: 'Aaron Judge', team: 'New York Yankees', stats: { hr: 58, rbi: 144, avg: .322 }, statLabel: '2024 Season' },
    showdown_category: 'WHO WON THE 2024 NL MVP?',
    showdown_correct_answer: 'a',
    showdown_correct_reason: 'Ohtani won the NL MVP unanimously — his first 50-50 season in history, hitting .310 with 54 HR and 59 SB for the Dodgers.',
    blind_rank_players: [
  ...
  // ─── 2026-03-26 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Ted Williams', team: 'Boston Red Sox', stats: { career_avg: .344, career_obp: .482, last_400_hitter: true }, statLabel: 'Career' },
    showdown_player_b: { name: 'Pete Rose', team: 'Cincinnati Reds', stats: { career_hits: 4256, batting_titles: 3, career_avg: .303 }, statLabel: 'Career' },
    showdown_category: 'GREATEST PURE HITTER EVER?',
    showdown_correct_answer: 'a',
    showdown_correct_reason: 'Williams\' .344 career average and .482 career OBP are both the highest in baseball history — and he hit .406 in 1941, the last player ever to bat .400.',
    blind_rank_players: [
  ...
  // ─── 2026-03-27 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Shohei Ohtani', team: 'Los Angeles Dodgers', stats: { hr: 54, sb: 59 }, statLabel: '2024 Season (batting only)' },
    showdown_player_b: { name: 'Babe Ruth', team: 'New York Yankees', stats: { hr: 60, sb_career: 123, era: 2.28 }, statLabel: 'Career two-way (1916-1935)' },
    showdown_category: 'GREATEST TWO-WAY PLAYER IN MLB HISTORY?',
    showdown_correct_answer: 'b',
    showdown_correct_reason: 'Ruth was a World Series-winning ace pitcher (0.87 postseason ERA) AND the greatest slugger ever — a combination no one, not even Ohtani, has fully matched.',
    blind_rank_players: [
  ...
  // ─── 2026-03-28 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Cal Ripken Jr', team: 'Baltimore Orioles', stats: { consecutive_games: 2632, career_hr: 431, career_avg: .276 }, statLabel: 'Career' },
    showdown_player_b: { name: 'Derek Jeter', team: 'New York Yankees', stats: { career_hits: 3465, ws_rings: 5, postseason_avg: .308 }, statLabel: 'Career' },
    showdown_category: 'GREATER LEGACY: RIPKEN OR JETER?',
    showdown_correct_answer: 'a',
    showdown_correct_reason: 'Ripken\'s 2,632 consecutive games is baseball\'s most sacred record — pure dedication that changed how the sport thought about daily commitment.',
    blind_rank_players: [
  ...
  // ─── 2026-03-29 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Nolan Ryan', team: 'Texas Rangers', stats: { career_k: 5714, career_wins: 324, no_hitters: 7 }, statLabel: 'Career' },
    showdown_player_b: { name: 'Randy Johnson', team: 'Arizona Diamondbacks', stats: { career_k: 4875, career_era: 3.29, cy_youngs: 5 }, statLabel: 'Career' },
    showdown_category: 'MOST DOMINANT STRIKEOUT PITCHER EVER?',
    showdown_correct_answer: 'a',
    showdown_correct_reason: 'Ryan\'s 5,714 career strikeouts are 839 more than any other pitcher in history — a record so dominant it may stand for the rest of baseball\'s existence.',
    blind_rank_players: [
  ...
  // ─── 2026-03-30 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Aaron Judge', team: 'New York Yankees', stats: { hr: 58, rbi: 144, al_mvp: true }, statLabel: '2024 Season' },
    showdown_player_b: { name: 'Vladimir Guerrero Jr', team: 'Toronto Blue Jays', stats: { avg: .323, hr: 30, rbi: 103 }, statLabel: '2024 Season' },
    showdown_category: 'WHO WAS THE AL\'S BEST HITTER IN 2024?',
    showdown_correct_answer: 'a',
    showdown_correct_reason: 'Judge won the AL MVP with 58 HRs — the AL record he set in 2022 — with a .322 average and 144 RBI that made him the clear choice.',
    blind_rank_players: [
  ...
  // ─── 2026-03-31 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Freddie Freeman', team: 'Los Angeles Dodgers', stats: { avg: .282, hr: 22, walk_off_ws_slam: true }, statLabel: '2024 World Series Hero' },
    showdown_player_b: { name: 'Trea Turner', team: 'Philadelphia Phillies', stats: { avg: .283, hr: 26, sb: 30 }, statLabel: '2024 Season' },
    showdown_category: 'BETTER NL INFIELDER IN 2024?',
    showdown_correct_answer: 'a',
    showdown_correct_reason: 'Freeman\'s World Series walk-off grand slam cemented his place in Dodger lore — and his steady production (.282, 22 HR, 89 RBI) gave him the edge over Turner.',
    blind_rank_players: [
  ...
  // ─── 2026-04-01 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Mookie Betts', team: 'Los Angeles Dodgers', stats: { career_war: 60.2, gold_gloves: 6, ws_rings: 2 }, statLabel: 'Career thru 2024' },
    showdown_player_b: { name: 'Juan Soto', team: 'New York Mets', stats: { career_obp: .421, hr: 41, ops: .989 }, statLabel: '2024 Season / Career OBP' },
    showdown_category: 'BETTER OVERALL PLAYER IN THE NL IN 2024?',
    showdown_correct_answer: 'b',
    showdown_correct_reason: 'Soto\'s .419 OBP and 41 HRs made him the most complete offensive threat in the NL — his walk rate and power combination is unique in modern baseball.',
    blind_rank_players: [
  ...
  // ─── 2026-04-02 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Yordan Alvarez', team: 'Houston Astros', stats: { hr: 35, rbi: 88, ops: .961 }, statLabel: '2024 Season' },
    showdown_player_b: { name: 'Freddie Freeman', team: 'Los Angeles Dodgers', stats: { hr: 22, rbi: 89, ws_hero: true }, statLabel: '2024 Season' },
    showdown_category: 'WHO BROUGHT MORE VALUE TO THEIR TEAM IN 2024?',
    showdown_correct_answer: 'b',
    showdown_correct_reason: 'Freeman\'s World Series walk-off grand slam and clutch production all October made him the most valuable player to his team\'s championship run.',
    blind_rank_players: [
  ...
  // ─── 2026-04-03 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Shohei Ohtani', team: 'Los Angeles Dodgers', stats: { hr: 54, sb: 59, ops: 1.036 }, statLabel: '2024 Season' },
    showdown_player_b: { name: 'Mike Trout', team: 'Los Angeles Angels', stats: { career_war: 85.2, al_mvps: 3, career_ops: .994 }, statLabel: 'Career thru 2024' },
    showdown_category: 'GREATER ANGELS/DODGERS LA LEGACY?',
    showdown_correct_answer: 'a',
    showdown_correct_reason: 'Ohtani\'s 2024 historic 50-50 season and $700M contract capture the moment — and his peak performance is unparalleled in baseball history.',
    blind_rank_players: [
  ...
  // ─── 2026-04-04 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Aaron Judge', team: 'New York Yankees', stats: { hr: 58, avg: .322, rbi: 144 }, statLabel: '2024 Season' },
    showdown_player_b: { name: 'Ted Williams', team: 'Boston Red Sox', stats: { single_season_avg: .406, career_obp: .482, hr_vs_career: 521 }, statLabel: 'Best Season / Career' },
    showdown_category: 'MORE IMPRESSIVE SINGLE STAT SEASON?',
    showdown_correct_answer: 'b',
    showdown_correct_reason: 'Williams\' .406 average in 1941 is a record that hasn\'t been touched in over 80 years — no one has come within 30 points of it since.',
    blind_rank_players: [
  ...
  // ─── 2026-04-05 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Juan Soto', team: 'New York Mets', stats: { ops: .989, obp: .419, hr: 41 }, statLabel: '2024 Season' },
    showdown_player_b: { name: 'Mookie Betts', team: 'Los Angeles Dodgers', stats: { career_ops: .895, gold_gloves: 6, ws_rings: 2 }, statLabel: 'Career thru 2024' },
    showdown_category: 'BETTER LONG-TERM NL STAR?',
    showdown_correct_answer: 'b',
    showdown_correct_reason: 'Betts combines elite hitting (.895 career OPS), defense (6 Gold Gloves), and championships (2 WS rings) into the most complete player package.',
    blind_rank_players: [
  ...
  // ─── 2026-04-06 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Sandy Koufax', team: 'Los Angeles Dodgers', stats: { best_era: 1.73, k_per_9: 10.4, era_plus: 131 }, statLabel: '1966 Season' },
    showdown_player_b: { name: 'Clayton Kershaw', team: 'Los Angeles Dodgers', stats: { career_era: 2.48, cy_youngs: 3, mvp_awards: 1 }, statLabel: 'Career thru 2024' },
    showdown_category: 'GREATEST DODGER PITCHER EVER?',
    showdown_correct_answer: 'a',
    showdown_correct_reason: 'Koufax\'s 4-year dominance (1963-1966) with 4 no-hitters, 3 Cy Youngs, and a career 2.76 ERA in a harder-hit era makes him the benchmark for Dodger pitching greatness.',
    blind_rank_players: [
      { name: 'Albert Pujols', team: 'St. Louis Cardinals', rankingStat: 700, statLabel: 'Career Home Runs' },
      { name: 'Babe Ruth', team: 'New York Yankees', rankingStat: 714, statLabel: 'Career Home Runs' },
      { name: 'Barry Bonds', team: 'San Francisco Giants', rankingStat: 762, statLabel: 'Career Home Runs (official)' },
  ...
  // ─── 2026-04-07 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Fernando Tatis Jr', team: 'San Diego Padres', stats: { hr: 31, sb: 29, ops: .820 }, statLabel: '2024 Season' },
    showdown_player_b: { name: 'Yordan Alvarez', team: 'Houston Astros', stats: { hr: 35, rbi: 88, ops: .961 }, statLabel: '2024 Season' },
    showdown_category: 'BETTER AL SLUGGER IN 2024?',
    showdown_correct_answer: 'b',
    showdown_correct_reason: 'Alvarez\'s .961 OPS and 35 HRs gave him a massive edge in pure offensive production over Tatis\', whose .820 OPS reflected a down year.',
    blind_rank_players: [
      { name: 'Randy Johnson', team: 'Arizona Diamondbacks', rankingStat: 4875, statLabel: 'Career Strikeouts' },
  ...
  // ─── 2026-04-08 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Aaron Judge', team: 'New York Yankees', stats: { career_hr: 258, career_avg: .283, mvp_awards: 2 }, statLabel: 'Career thru 2024' },
    showdown_player_b: { name: 'Ken Griffey Jr', team: 'Seattle Mariners', stats: { career_hr: 630, career_avg: .284, gold_gloves: 10 }, statLabel: 'Career' },
    showdown_category: 'GREATER FRANCHISE PLAYER OF THEIR ERA?',
    showdown_correct_answer: 'b',
    showdown_correct_reason: 'Griffey\'s 630 HRs, 10 Gold Gloves, and iconic Mariners legacy make him one of the most beloved and complete players in baseball history.',
    blind_rank_players: [
  ...
  // ─── 2026-04-09 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Shohei Ohtani', team: 'Los Angeles Dodgers', stats: { hr: 54, sb: 59, ops: 1.036 }, statLabel: '2024 Season' },
    showdown_player_b: { name: 'Ronald Acuna Jr', team: 'Atlanta Braves', stats: { prev_2023_hr: 41, prev_2023_sb: 73, prev_2023_ops: 1.012 }, statLabel: '2023 Historic Season' },
    showdown_category: 'MORE HISTORICALLY IMPRESSIVE 50-50 ADJACENT SEASON?',
    showdown_correct_answer: 'a',
    showdown_correct_reason: 'Ohtani actually achieved the 50-50 (54 HR / 59 SB) in 2024 — Acuna\'s 2023 was legendary but he fell short of 50 stolen bases and didn\'t hit 50 HRs.',
    blind_rank_players: [
      { name: 'Clayton Kershaw', team: 'Los Angeles Dodgers', rankingStat: 2.48, statLabel: 'Career ERA (thru 2024)' },
  ...
  // ─── 2026-04-10 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Mookie Betts', team: 'Los Angeles Dodgers', stats: { avg: .289, ops: .908, gold_gloves: 6 }, statLabel: '2024 Season / Career' },
    showdown_player_b: { name: 'Trea Turner', team: 'Philadelphia Phillies', stats: { avg: .283, hr: 26, sb: 30 }, statLabel: '2024 Season' },
    showdown_category: 'BETTER ALL-AROUND PLAYER IN 2024?',
    showdown_correct_answer: 'a',
    showdown_correct_reason: 'Betts\' combination of elite hitting (.289, .908 OPS), elite defense, and World Series impact makes him the more complete player.',
    blind_rank_players: [
  ...
  // ─── 2026-04-11 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Aaron Judge', team: 'New York Yankees', stats: { hr: 58, rbi: 144, al_mvp_votes: '29 of 30 first place' }, statLabel: '2024 AL MVP Season' },
    showdown_player_b: { name: 'Shohei Ohtani', team: 'Los Angeles Dodgers', stats: { hr: 54, sb: 59, nl_mvp_votes: 'unanimous' }, statLabel: '2024 NL MVP Season' },
    showdown_category: 'WHO HAD THE MORE HISTORICALLY SIGNIFICANT 2024 SEASON?',
    showdown_correct_answer: 'b',
    showdown_correct_reason: 'Ohtani\'s 50-50 season is the first in MLB history — a record that redefines what\'s possible. Judge\'s 58 HRs were his second great season but didn\'t set new precedent.',
    blind_rank_players: [
  ...
  // ─── 2026-04-12 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Sandy Koufax', team: 'Los Angeles Dodgers', stats: { era: 2.76, no_hitters: 4, cy_youngs: 3 }, statLabel: 'Career Highlights' },
    showdown_player_b: { name: 'Randy Johnson', team: 'Arizona Diamondbacks', stats: { career_k: 4875, cy_youngs: 5, k_per_9: 10.6 }, statLabel: 'Career' },
    showdown_category: 'BETTER LEFTY PITCHER EVER?',
    showdown_correct_answer: 'b',
    showdown_correct_reason: 'Johnson\'s 5 Cy Young awards and 4,875 strikeouts across 22 seasons edge out Koufax\'s brilliant but abbreviated career (only 3 elite seasons).',
    blind_rank_players: [
  ...
  // ─── 2026-04-13 ───────────────────────────────────────────────────────────
  {
    ...
    showdown_player_a: { name: 'Shohei Ohtani', team: 'Los Angeles Dodgers', stats: { hr: 54, sb: 59, ops: 1.036, unanimous_mvp: true }, statLabel: '2024 Season' },
    showdown_player_b: { name: 'Babe Ruth', team: 'New York Yankees', stats: { career_hr: 714, single_season_hr_record: 60, career_ops: 1.164 }, statLabel: 'Career / 1927 Season' },
    showdown_category: 'MOST DOMINANT OFFENSIVE FORCE IN BASEBALL HISTORY?',
    showdown_correct_answer: 'b',
    showdown_correct_reason: 'Ruth\'s .342 career average, 714 HRs, 1.164 career OPS — plus his pitching — make him the consensus greatest player to ever live. His sheer dominance relative to his era has never been matched.',
    blind_rank_players: [
